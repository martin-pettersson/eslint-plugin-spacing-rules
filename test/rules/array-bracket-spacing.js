...
new RuleTester().run("array-bracket-spacing", rule, {
    valid: [
        ...
        { code: "([ a, b ]: Array<any>) => {}", options: ["always"], parser: flowDestructuring1, parserOptions: { ecmaVersion: 6 } },
        { code: "([a, b]: Array< any >) => {}", options: ["never"], parser: flowDestructuring2, parserOptions: { ecmaVersion: 6 } }
    ],
    invalid: [
        {
            code: "var foo = [ ]",
